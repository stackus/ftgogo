...
CREATE TABLE accounting.events
(
    LIKE public.events INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING INDEXES
);
CREATE TABLE accounting.messages
(
    LIKE public.messages INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING INDEXES
);
CREATE TABLE accounting.saga_instances
(
    LIKE public.saga_instances INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING INDEXES
);
CREATE TABLE accounting.snapshots
(
    LIKE public.snapshots INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING INDEXES
);
-- accounting access
...
CREATE TABLE consumer.events
(
    LIKE public.events INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING INDEXES
);
CREATE TABLE consumer.messages
(
    LIKE public.messages INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING INDEXES
);
CREATE TABLE consumer.saga_instances
(
    LIKE public.saga_instances INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING INDEXES
);
CREATE TABLE consumer.snapshots
(
    LIKE public.snapshots INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING INDEXES
);
-- consumer access
...
CREATE TABLE delivery.saga_instances
(
    LIKE public.saga_instances INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING INDEXES
);
CREATE TABLE delivery.snapshots
(
    LIKE public.snapshots INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING INDEXES
);
...
CREATE TABLE kitchen.events
(
    LIKE public.events INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING INDEXES
);
CREATE TABLE kitchen.messages
(
    LIKE public.messages INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING INDEXES
);
CREATE TABLE kitchen.saga_instances
(
    LIKE public.saga_instances INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING INDEXES
);
CREATE TABLE kitchen.snapshots
(
    LIKE public.snapshots INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING INDEXES
);
...
CREATE TABLE orders.messages
(
    LIKE public.messages INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING INDEXES
);
CREATE TABLE orders.saga_instances
(
    LIKE public.saga_instances INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING INDEXES
);
...
CREATE TABLE orderhistory.events
(
    LIKE public.events INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING INDEXES
);
CREATE TABLE orderhistory.messages
(
    LIKE public.messages INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING INDEXES
);
CREATE TABLE orderhistory.saga_instances
(
    LIKE public.saga_instances INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING INDEXES
);
CREATE TABLE orderhistory.snapshots
(
    LIKE public.snapshots INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING INDEXES
);
...
CREATE TABLE restaurant.events
(
    LIKE public.events INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING INDEXES
);
...
CREATE TABLE restaurant.saga_instances
(
    LIKE public.saga_instances INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING INDEXES
);
CREATE TABLE restaurant.snapshots
(
    LIKE public.snapshots INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING INDEXES
);
