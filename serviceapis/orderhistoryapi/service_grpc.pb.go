...
func (c *orderHistoryServiceClient) GetConsumerOrderHistory(ctx context.Context, in *GetConsumerOrderHistoryRequest, opts ...grpc.CallOption) (*GetConsumerOrderHistoryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/orderhistoryapi.OrderHistoryService/GetConsumerOrderHistory", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderHistoryServiceClient) GetOrderHistory(ctx context.Context, in *GetOrderHistoryRequest, opts ...grpc.CallOption) (*GetOrderHistoryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/orderhistoryapi.OrderHistoryService/GetOrderHistory", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _OrderHistoryService_GetConsumerOrderHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/orderhistoryapi.OrderHistoryService/GetConsumerOrderHistory",
	}
...
func _OrderHistoryService_GetOrderHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/orderhistoryapi.OrderHistoryService/GetOrderHistory",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var OrderHistoryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "orderhistoryapi.OrderHistoryService",
	...
	Metadata: "orderhistoryapi/service.proto",
}
